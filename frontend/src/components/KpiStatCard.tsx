...
export type KpiStatCardTone = "rose" | "blush" | "featured" | "sage" | "gold";
...
const toneSurfaces: Record<KpiStatCardTone, string> = {
...
const blobColors: Record<KpiStatCardTone, string> = {
