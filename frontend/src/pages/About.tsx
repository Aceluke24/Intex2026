  ...
  return (
    <PublicLayout>
      ...
      <section className="py-16 lg:py-20 gradient-section-blush">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl lg:text-3xl font-bold text-foreground mb-4">How Girls Are Found</h2>
      ...
      <section className="py-16 lg:py-20 bg-background">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="font-display text-2xl lg:text-3xl font-bold text-foreground mb-6">Today vs Future</h2>
      ...
      <section className="py-16 lg:py-20 gradient-cream-warm">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-display text-2xl lg:text-3xl font-bold text-foreground mb-4">Learn More About Our Mission</h2>
