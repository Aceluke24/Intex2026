...
public class Resident
{
    ...
    public string CaseStatus { get; set; } = string.Empty; // Active | Closed | Transferred
    public string Sex { get; set; } = "F";
    public DateOnly DateOfBirth { get; set; }
    public string? BirthStatus { get; set; }    // Marital | Non-Marital
    public string? PlaceOfBirth { get; set; }
    public string? Religion { get; set; }
    public string CaseCategory { get; set; } = string.Empty; // Abandoned | Foundling | Surrendered | Neglected
    ...
    // Referral
    public string? ReferralSource { get; set; } // Government Agency | NGO | Police | Self-Referral | Community | Court Order
    ...
    // Reintegration
    public string? ReintegrationType { get; set; }   // Family Reunification | Foster Care | Adoption (Domestic) | Adoption (Inter-Country) | Independent Living | None
    public string? ReintegrationStatus { get; set; } // Not Started | In Progress | Completed | On Hold

    // Risk levels
    public string InitialRiskLevel { get; set; } = string.Empty; // Low | Medium | High | Critical
